...
def define_components(m):
    ...
    #marginal cost of serving UH
    m.MarginalPowerCost = Expression(
        m.TIMEPOINTS, rule=lambda m, tp: m.PurchasePower[tp] * m.marginal_power_price[tp]
    )
    #m.Cost_Components_Per_TP.append('MarginalPowerCost')
...
def post_solve(instance, outdir):
    ...
    tp_costs = instance.Cost_Components_Per_TP + ['MarginalPowerCost']
